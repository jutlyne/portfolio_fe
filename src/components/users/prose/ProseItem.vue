  ...
  <div class="rendered-article prose mt-6">
    ...
    <figure class="my-8">
      <a
        target="_blank"
        rel="noopener"
        title="Auto backup và dịch vụ thêm."
        ><img
          class="m-auto block max-h-screen max-w-full rounded-xl object-cover shadow-md"
          src="https://hoanghamobile.com/tin-tuc/wp-content/webp-express/webp-images/uploads/2024/03/anh-meo-5.jpg.webp"
    ...
    <figure class="my-8">
      <a
        target="_blank"
        rel="noopener"
        title="Click add new để thêm SSH Key vào nhé"
        ><img
          class="m-auto block max-h-screen max-w-full rounded-xl object-cover shadow-md"
          src="https://hoanghamobile.com/tin-tuc/wp-content/webp-express/webp-images/uploads/2024/03/anh-meo-5.jpg.webp"
    ...
    <figure class="my-8">
      <a
        target="_blank"
        rel="noopener"
        title="Thông tin instance sau khi tạo"
        ><img
          class="m-auto block max-h-screen max-w-full rounded-xl object-cover shadow-md"
          src="https://hoanghamobile.com/tin-tuc/wp-content/webp-express/webp-images/uploads/2024/03/anh-meo-5.jpg.webp"
